...
{
    app_test_result const result = execute_app("minimal_hibf");
...
{
    app_test_result const result = execute_app("minimal_hibf", "-v");
...
{
    app_test_result const result = execute_app("minimal_hibf", data("in.fastq"));
...
{
    app_test_result const result = execute_app("minimal_hibf", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("minimal_hibf", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("minimal_hibf", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("minimal_hibf", data("in.fastq"), "-o", "does_not_exist/out.fasta");
